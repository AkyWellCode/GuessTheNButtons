let buttons = 1, winnerButton, text = document.createElement("text");

function addButtons() {
  let insertButtons = document.getElementById("insertButtons"), numberOfButtons = document.getElementById("numberOfButtons").value, randomButton = Math.floor(Math.random() * numberOfButtons) + 1;
  winnerButton = randomButton;
...
function guessButton(clicked_id) {
  if (Number(clicked_id) === winnerButton) {
